...
# Formatting values on visualizations.
...
# Creating one legend for all the subplots.
handles, labels = axs[0].get_legend_handles_labels()
fig1.legend(handles, labels, loc='upper left', bbox_to_anchor=(0.05 , 0.97)) 

# Last correcting and saving the visualization.
sns.despine()
plt.tight_layout()  
plt.savefig('C:\\Users\\artjo\\.vscode\\HealthCare Estonia Analysis\\visualizations\\questions_1-3')
...
sns.despine()
plt.tight_layout()
plt.savefig("C:\\Users\\artjo\\.vscode\\HealthCare Estonia Analysis\\visualizations\\question_4")